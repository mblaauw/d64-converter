...
- Extracted 4 directory entries into `out/hoa/disk/files`.
...
- Game start (t0) detected at frame 1148: IRQ vector left the KERNAL default and the screen base left $0400. Earlier frames are the loader phase.
- Applied 36 joystick input events from the default autoplay script.
- Probe experiments found 0 input-sensitive ranges.
- Execution coverage: 2 executed bytes.
- Disassembled 2 executed instructions into `reports/disassembly.md`.
