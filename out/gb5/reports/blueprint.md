...
- Extracted 1 directory entries into `out/gb5/disk/files`.
- Captured live VICE RAM after 60 seconds into `snapshots/vice-capture.ram`.
- Collected 300 hardware samples into `traces/hardware-samples.json`.
...
- Applied 108 joystick input events from the default autoplay script.
