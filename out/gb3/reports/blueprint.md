...
- Extracted 1 directory entries into `out/gb3/disk/files`.
...
- Game start (t0) detected at frame 150: IRQ vector left the KERNAL default and the screen base left $0400. Earlier frames are the loader phase.
