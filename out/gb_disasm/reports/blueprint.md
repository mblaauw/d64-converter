...
- Extracted 1 directory entries into `out/gb_disasm/disk/files`.
...
- Game start (t0) detected at frame 4292: IRQ vector left the KERNAL default and the screen base left $0400. Earlier frames are the loader phase.
