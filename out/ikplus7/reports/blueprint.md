...
- Extracted 8 directory entries into `out/ikplus7/disk/files`.
- Captured live VICE RAM after 30 seconds into `snapshots/vice-capture.ram`.
- Collected 150 hardware samples into `traces/hardware-samples.json`.
...
- Applied 54 joystick input events from the default autoplay script.
